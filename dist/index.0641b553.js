...
async function fetchData() {
    try {
        ...
        const response = await (0, _axiosDefault.default).get(`https://dummyjson.com/recipes/${randomNumber}`);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gbXMy","bNKaB"], "bNKaB", "parcelRequire26c0")
